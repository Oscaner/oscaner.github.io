...
![1.png](/img/in-post/skill/others/post-git-course/1.png)
...
![2.png](/img/in-post/skill/others/post-git-course/2.png)

而 Git 则是将每个版本独立保存

![3.png](/img/in-post/skill/others/post-git-course/3.png)
...
![4.png](/img/in-post/skill/others/post-git-course/4.png)
...
![14.png](/img/in-post/skill/others/post-git-course/14.png)
...
1. 创建项目文件夹, 并初始化仓库
    ...
    ![5.png](/img/in-post/skill/others/post-git-course/5.png)
...
2. 添加 `README.md` 文件, 并提交到 Git 仓库
    ...
    ![6.png](/img/in-post/skill/others/post-git-course/6.png)
...
![7.png](/img/in-post/skill/others/post-git-course/7.png)

1. 添加 `LICENSE` 文件后

    ![8.png](/img/in-post/skill/others/post-git-course/8.png)

2. 将 `LICENSE` 加入暂存区

    ![9.png](/img/in-post/skill/others/post-git-course/9.png)

3. 将暂存区的最新记录撤回

    ![10.png](/img/in-post/skill/others/post-git-course/10.png)

4. 将 `LICENSE` 提交到仓库, 并修改 `LICENSE` 文件

    ![11.png](/img/in-post/skill/others/post-git-course/11.png)
...
![15.png](/img/in-post/skill/others/post-git-course/15.png)
...
- 比较两个历史快照
    ...
    ![16.png](/img/in-post/skill/others/post-git-course/16.png)
...
![17.png](/img/in-post/skill/others/post-git-course/17.png)
...
![18.png](/img/in-post/skill/others/post-git-course/18.png)
...
- 创建 `feature` 分支
    ...
    ![19.png](/img/in-post/skill/others/post-git-course/19.png)
...
- 切换到 `feature` 分支
    ...
    ![20.png](/img/in-post/skill/others/post-git-course/20.png)
